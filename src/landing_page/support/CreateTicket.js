    ...
    return (
        <div className='container'>
            <div className='row p-4 mt-5'>
                <h1 className='fs-3 '>To create a ticket, select a relevant topic
                </h1>
                <div className='col-4 pt-5 mb-2 mt-2 text-muted'>
                    <h4 className=' mb-5'><i class="fa fa-plus-circle" aria-hidden="true"></i> Account Opening
                    </h4>
                    ...
                    <a href='/'  style={{ textDecoration: "none", lineHeight: "2.5"  }}>NIR Account Opening</a><br></br>
                ...
                <div className='col-4 pt-5 mb-2 mt-2 text-muted'>
                    <h4 className='mb-5'><i class="fa fa-user" aria-hidden="true"></i> Your Zerodha Account
                    </h4>
                ...
                <div className='col-4 pt-5 mb-2 mt-2 text-muted'>
                    <h4 className='mb-5'><i class="fa fa-bar-chart" aria-hidden="true"></i> Your Zerodha Kite
                    </h4>
                    ...
                    <a href='/' style={{ textDecoration: "none", lineHeight: "2.5" }}>Corporate Action</a><br></br>
                ...
                <div className='col-4 mb-2 mt-2 text-muted'>
                    <h4 className='mb-5'><i class="fa fa-credit-card" aria-hidden="true"></i> Funds
                    </h4>
                    <a href='/' style={{ textDecoration: "none", lineHeight: "2.5" }}>Adding Funds</a><br></br>
                    <a href='/' style={{ textDecoration: "none", lineHeight: "2.5" }}>Funds Withdrawal</a><br></br>
                ...
                <div className='col-4  mb-2 mt-2 text-muted'>
                    <h4 className='mb-5'><i class="fa fa-circle-o-notch" aria-hidden="true"></i> Console
                    </h4>
                ...
                <div className='col-4  mb-2 mt-2 text-muted'>
                    <h4 className='mb-5'><i class="fa fa-circle-thin" aria-hidden="true"></i> Coin
                    </h4>
                    ...
                    <a href='/' style={{ textDecoration: "none", lineHeight: "2.5" }}>Buying and Selling through Coin</a><br></br>
                    <a href='/' style={{ textDecoration: "none", lineHeight: "2.5" }}>Starting an SIP</a><br></br>
                    <a href='/' style={{ textDecoration: "none", lineHeight: "2.5" }}>Managing your Portfolio</a><br></br>
                    <a href='/' style={{ textDecoration: "none", lineHeight: "2.5" }}>Coin app</a><br></br>
                    <a href='/' style={{ textDecoration: "none", lineHeight: "2.5" }}>Moving to Coin</a><br></br>
                    <a href='/' style={{ textDecoration: "none", lineHeight: "2.5" }}>Government Securities</a><br></br>
                    <br></br>
                </div>
            </div>
